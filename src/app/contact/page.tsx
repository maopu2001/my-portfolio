  ...
  return (
    <div className="flex flex-col gap-2 border border-myborder p-4 rounded-lg">
      ...
      <div className="flex items-center justify-around px-5">
        <Link className="flex flex-col items-center justify-center" href="mailto:maopu2001@gmail.com">
          <div className="w-24">{icons.Email}</div>
          <span className="text-2xl font-bold">Email</span>
          maopu2001@gmail.com
        </Link>
        <Link className="flex flex-col items-center justify-center" href="https://www.facebook.com/ma.opu.2001/">
